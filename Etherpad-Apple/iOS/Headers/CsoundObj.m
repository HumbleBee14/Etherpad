  ...
  @autoreleasepool {
    ...
    if(!ret) {
      ...
      if(!ret) {    
        ...
        // Csound 7 removed csoundGetOutputBufferSize. The host-driven I/O
        // path renders one ksmps block per callback, so ksmps is the right
        // frame count here.
        mCsData.bufframes = csoundGetKsmps(cs);
        mCsData.running = true;
